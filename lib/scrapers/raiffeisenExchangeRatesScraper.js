...
const BASE_URL = 'http://raiffeisenpolbank.com/kursy-walut/tabela-kursow-walut/-/amg-currency-list/amgcurrencylist_WAR_amgcurrencyportlet/show-rates'

function dateParam (date) {
  return {
    _amgcurrencylist_WAR_amgcurrencyportlet_rateDate0: date
  }
}
...
function timeParam (time) {
  if (!time) return {}
  return {
    _amgcurrencylist_WAR_amgcurrencyportlet_rateTime0: time
  }
}
